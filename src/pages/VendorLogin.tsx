    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">{t('auth.vendorLogin')}</h1>
          ...
          <CardContent className="p-8">
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2">
                ...
                <TabsTrigger value="signup">{t('auth.vendorSignup')}</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="login" className="space-y-6">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-teal-600 to-purple-600 hover:from-teal-700 hover:to-purple-700 text-white">
                    Sign In
                  </Button>
                </form>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">
                      I agree to the{" "}
                      <a href="#" className="text-teal-600 hover:text-teal-800">Terms of Service</a>{" "}
                      and{" "}
