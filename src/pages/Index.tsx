      ...
      <div className="relative z-10">
        ...
        <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-center h-auto sm:h-20 py-3 sm:py-0 gap-3 sm:gap-0">
              <Link to="/" className="flex items-center group flex-shrink-0">
                <img 
                  src={logoImage} 
                  alt="Kiro Logo" 
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-lg object-cover transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg"
                />
              </Link>
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 w-full sm:w-auto">
                <div className="hidden md:flex items-center space-x-4">
                  <a href="#features" className="text-xs text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-105 relative group whitespace-nowrap">
                    {t('home.features')}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                  <a href="#how-it-works" className="text-xs text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-105 relative group whitespace-nowrap">
                    {t('home.howItWorks')}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                  <a href="#contact" className="text-xs text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-105 relative group whitespace-nowrap">
                    {t('home.contact')}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </div>
                <div className="flex items-center flex-wrap justify-center gap-2 sm:space-x-2">
                  <LanguageSelector />
                  <Link to="/vendor-login" className="flex-shrink-0">
                    <Button variant="outline" size="sm" className="border-2 border-green-600 text-green-600 hover:bg-green-50 hover:border-green-700 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg text-xs whitespace-nowrap">
                      <span className="hidden sm:inline">🏪 </span>
                      <span className="hidden sm:inline">{t('home.forStores')}</span>
                      <span className="sm:hidden">🏪</span>
                    </Button>
                  </Link>
                  <Link to="/delivery-login" className="flex-shrink-0">
                    <Button variant="outline" size="sm" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 hover:border-blue-700 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg text-xs whitespace-nowrap">
                      <span className="hidden sm:inline">🚚 </span>
                      <span className="hidden sm:inline">{t('home.forDelivery')}</span>
                      <span className="sm:hidden">🚚</span>
                    </Button>
                  </Link>
                  <Link to="/start-shopping" className="flex-shrink-0">
                    <Button size="sm" className="bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 text-white px-3 sm:px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg text-xs whitespace-nowrap">
            ...
            <div className="text-center">
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap px-4">
                  <Link to="/start-shopping" className="w-full sm:w-auto">
                    <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 text-white px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-lg group">
                      {t('home.startShopping')}
                      <ArrowRight className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" />
                    </Button>
                  </Link>
                  <Link to="/vendor-login" className="w-full sm:w-auto">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-green-600 text-green-600 hover:bg-green-50 hover:border-green-700 px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      🏪 {t('home.joinAsVendor')}
                    </Button>
                  </Link>
                  <Link to="/delivery-login" className="w-full sm:w-auto">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-blue-600 text-blue-600 hover:bg-blue-50 hover:border-blue-700 px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      🚚 {t('home.joinAsDelivery')}
                    </Button>
                  </Link>
                  <Link to="/price-prediction" className="w-full sm:w-auto">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-purple-600 text-purple-600 hover:bg-purple-50 hover:border-purple-700 px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <section className="py-20 bg-gradient-to-r from-green-600/90 to-emerald-500/90 backdrop-blur-xl">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap px-4">
              <Link to="/start-shopping" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-white/90 backdrop-blur-sm text-green-600 hover:bg-white hover:shadow-2xl px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 group">
                  🛒 {t('home.startShoppingNow')}
                  <ArrowRight className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" />
                </Button>
              </Link>
              <Link to="/vendor-login" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-white/80 backdrop-blur-sm text-green-600 hover:bg-white hover:shadow-xl px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105">
                  🏪 {t('home.joinAsVendor')}
                </Button>
              </Link>
              <Link to="/delivery-login" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-white/80 backdrop-blur-sm text-blue-600 hover:bg-white hover:shadow-xl px-6 sm:px-8 py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105">
                  🚚 {t('home.joinAsDelivery')}
                </Button>
              </Link>
            </div>
